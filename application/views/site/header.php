...
<!-- Head -->
<head>
<title>Banquet House | Home</title>
...
<link href="<?php echo base_url(); ?>assets/css/popup-box.css" rel="stylesheet" type="text/css" media="all" /><!-- popup css -->  

<!-- for banner css -->
<link href="<?php echo base_url(); ?>assets/css/carousel.css" type="text/css" rel="stylesheet" media="all"><!-- carousel css -->  
<!-- //for banner css -->
